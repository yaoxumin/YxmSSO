...
public class StringUtils {
	 ...
	 * @return
	 */
	public static boolean isNumericNotNull(CharSequence cs) {
		if (cs == null) {
			return false;
		}
		return isNumeric(cs);
	 ...
	 * @return
	 */
	public static boolean isNumericOrNull(CharSequence cs) {
		if (cs == null) {
			return true;
		}
		return isNumeric(cs);
...
//		String url = channel.getChannelUrl().toString();
//		String channelUrl = url.replaceAll("^.*?www", "www");
//		String code = channel.getCompanyid() + "," + channel.getChannelId()
//				+ "," + channelUrl;
//		String channelCode = MD5Utils.getMd5Value(code).substring(8, 24);
//		return channelCode;
//	}
//
//	/**
...
//	 * @return
//	 */
//	public static String getSyscode(Syschannel syschannel) {
//		String url = syschannel.getSyschannelUrl().toString();
//		String syschannelUrl = url.replaceAll("^.*?www", "www");
//		String code = 1 + "," + syschannel.getSyschannelId() + ","
//				+ syschannelUrl;
//		String syschannelCode = MD5Utils.getMd5Value(code).substring(8, 24);
