...
public class HttpClientUtil {
	...
	public static String postFormData(String url, String path, String formName)
			throws ClientProtocolException, IOException,
			GeneralSecurityException {
		return postFormData(url, new File(path), formName, null);
	}

	public static String postFormData(String url, String path, String formName,
			Map<String, String> extraParams) throws ClientProtocolException,
			IOException, GeneralSecurityException {
		return postFormData(url, new File(path), formName, extraParams);
	}

	public static String postFormData(String url, File file, String formName)
			throws ClientProtocolException, IOException,
			GeneralSecurityException {
		return postFormData(url, file, formName, null);
	}
	...
	/**
	 * post表单数据,需要引入httpmime-4.3.1.jar
	 *
	 * @param url
	 *            请求路径
	 * @param file
	...
	public static void postToFile(String url, Map<String, String> params,
	...
	public static void main(String[] args) {
		try {
			...
			String data = get("http://localhost/socket/json/0/sysstaff/sysstaff_1/init.json");
