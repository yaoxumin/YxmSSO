    ...
    return {
        init: function () {
            ...
            , {
                ...
                label: "下载量",
                data: [[1990, 8.3], [1991, 8.3], [1992, 7.8], [1993, 8.3], [1994, 8.4], [1995, 5.9], [1996, 6.4], [1997, 6.7], [1998, 6.9], [1999, 7.6], [2000, 7.4], [2001, 8.1], [2002, 12.5], [2003, 9.9], [2004, 11.0]]
            }];
            ...
            var options = {
                ...
                tooltipOpts: {
                    defaultTheme: false,
                    content: "<b>%s</b> : <span>%x</span> : <span>%y次</span>",
                },
                crosshair: {
                    mode: "x"
                }
