...
//    	  var tempObject = parent.$('#elemIframe')
    	  var tempObject = parent.document.getElementById(elemIframe);
    	  var tempTest = window.top.document.getElementById(elemIframe);
    	  tempTest.onpropertychange =  function() {
    		  tempTest = "进来了";
    	  }
    	  console.log("tempObject",tempTest);
